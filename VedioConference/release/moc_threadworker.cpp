...
#include "../infrastructure/concurrency/ThreadWorker.h"
...
QT_MOC_LITERAL(1, 13, 16), // "SIG_workFinished"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "ThreadWorker\0SIG_workFinished\0"
};
...
void ThreadWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadWorker::SIG_workFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ThreadWorker::SIG_workFinished()
{
