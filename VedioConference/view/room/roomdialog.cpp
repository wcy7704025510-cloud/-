...
{
    QString title=QString("房间�?%1").arg(roomid);
...
void RoomDialog::slot_removeUserShow(UserShow *user)
{
   ...
   //用户小窗口控件在画布对象上，由画布负责回收，不需要手动回收用户小窗口的额外空�?
}
